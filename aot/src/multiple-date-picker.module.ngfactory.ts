...
import * as import4 from './multiple-date-picker.component';
...
class MultipleDatePickerModuleInjector extends import0.NgModuleInjector<import1.MultipleDatePickerModule> {
  ...
  _MultipleDatePickerModule_1:import1.MultipleDatePickerModule;
  __NgLocalization_2:import3.NgLocaleLocalization;
  _MultipleDatePickerComponent_3:import4.MultipleDatePickerComponent;
  ...
  createInternal():import1.MultipleDatePickerModule {
    ...
    this._MultipleDatePickerModule_1 = new import1.MultipleDatePickerModule();
    this._MultipleDatePickerComponent_3 = new import4.MultipleDatePickerComponent();
    return this._MultipleDatePickerModule_1;
  }
  getInternal(token:any,notFoundResult:any):any {
    if ((token === import2.CommonModule)) { return this._CommonModule_0; }
    if ((token === import1.MultipleDatePickerModule)) { return this._MultipleDatePickerModule_1; }
    if ((token === import3.NgLocalization)) { return this._NgLocalization_2; }
    if ((token === import4.MultipleDatePickerComponent)) { return this._MultipleDatePickerComponent_3; }
